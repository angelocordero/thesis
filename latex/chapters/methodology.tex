...
\centering \begin{tikzpicture}
  ...
  \node[anchor=north west] (esp32) at (6, -3) {\includegraphics[width=3cm]{assets/esp-32.png}};
  \node[anchor=north west] (magnetometer) at (12, 0) {\includegraphics[width=3cm]{assets/magnetometer.png}};
  \node[anchor=north west] (gps) at (12, -5) {\includegraphics[width=3cm]{assets/gps_module.png}};
  \node[anchor=north west] (esc) at (0, -3) {\includegraphics[width=3cm]{assets/esc.png}};
  \node[anchor=north west] (motor) at (3, -7) {\includegraphics[width=3cm]{assets/motor.png}};
  \node[anchor=north west] (propeller) at (9, -7.2) {\includegraphics[width=3cm]{assets/propellers.png}};
